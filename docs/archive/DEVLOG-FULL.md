...
- Updated LESSONS-LEARNED.md entry #6 to note Zilean is now functional

**Indexer priority order:**
| Priority | Indexer |
|----------|---------|
| 1 | Zilean (DMM hashlist) |
| 25 | StremThru |
| 25 | The Pirate Bay |
| 25 | TorrentLeech |
| 25 | YTS |

**Follow-up:** Set TorrentLeech to priority 10 (second tier). Final indexer priority order:
...
3. **Failed to read LESSONS-LEARNED.md.** This exact problem (missing episodes not being searched) was already documented as Lesson #21, complete with root cause analysis and the previous fix. Reading this file early in the investigation would have provided the full context immediately.
